...
public class BedrockCreeperMod implements ModInitializer {
    ...
    */
    ...
    public void onInitialize() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_WHITE, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_GREEN, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_LIGHT_GRAY, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_RED, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_BLUE, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(CLASS_PANE_YELLOW, RenderLayer.getTranslucent());
